    ...
    <main className="min-h-screen">
        ...
        <div className="container mx-auto text-center">
            ...
            <div>
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
                Pursuing a dual degree in <span className="text-[#65B891] font-semibold">Electrical & Computer Engineering Honors</span> and <span className="text-[#65B891] font-semibold">Business Honors</span> at the University of Texas at Austin
              </p>
              <div className="mb-8">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative h-[400px] rounded-lg overflow-hidden bg-muted">
              <Image
                src="https://media.licdn.com/dms/image/v2/D5603AQHcoyB1YAfYRA/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1727535577756?e=1743033600&v=beta&t=mYtsUqgQnv-fwHT-AuyzJqppQXFlNYN7Y9VvT47bHkE" // Replace with your actual image URL
                alt="Profile"
                fill
            ...
            <div>
              <p className="text-lg mb-4">
                I am a dedicated student pursuing a challenging dual degree program in <span className="text-[#65B891] font-semibold">Electrical & Computer Engineering Honors</span> and <span className="text-[#65B891] font-semibold">Business Honors</span> at the University of Texas at Austin, with concentrations in Computer Architecture and Embedded Systems, and Finance.
              </p>
              <p className="text-lg mb-4">
                As a <span className="text-[#65B891] font-semibold">Technical Program Manager</span> at Texas Convergent and member of ECBA and HBA, I combine technical expertise with business acumen to drive innovation.
              </p>
            </div>
          </div>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Expected Graduation: May 2028</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <ul className="mt-2 list-disc list-inside space-y-1">
                      ...
                      <li>Optimized C++ scripts, improving prediction accuracy by <span className="text-[#65B891] font-semibold">30%</span></li>
                      <li>Increased avocado shelf life by <span className="text-[#65B891] font-semibold">117%</span> using Raspberry Pi-based system</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <ul className="mt-2 list-disc list-inside space-y-1">
                      ...
                      <li>Achieved <span className="text-[#65B891] font-semibold">600% return</span> above S&P 500</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li>• 2nd Place in Securities Industry and Financial Markets Association (SIFMA) Trading Competition</li>
                </ul>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="flex flex-col items-center gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <Button variant="outline" asChild>
                      <a href="https://linkedin.com/in/rajmhetar" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
      ...
      <footer className="py-8 border-t">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>© 2025 Raj Mhetar • Built with Next.js</p>
        </div>
      </footer>
    </main>
  )
