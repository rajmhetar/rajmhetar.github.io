              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Activities: Texas Guadaloop, Texas Iron Spikes, Longhorn Best Buddies
                  </div>
                </div>
              </div>
               ...
               <div className="border border-gray-200 rounded-lg p-6 bg-white shadow-sm">
                 <div className="flex items-start gap-4">
                   ...
                   <div className="flex-1">
                     ...
                     <a
                       href="/docs/RT_Wikipedia_Edit_Pipeline.pdf"
                       target="_blank"
                       rel="noopener noreferrer"
                       className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-blue-800 hover:text-blue-600 transition-colors"
                     >
